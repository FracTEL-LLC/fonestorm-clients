...
class FonenumbersApi
{
     ...
     * @return \Swagger\Client\Model\InlineResponse2014
     */
    public function setFonenumberServiceType($fonenumber, $service_type, $service_id = null)
    {
        list($response) = $this->setFonenumberServiceTypeWithHttpInfo($fonenumber, $service_type, $service_id);
        return $response;
    }

    /**
     * Operation setFonenumberServiceTypeWithHttpInfo
     *
     * Set Service Type
     *
     * @param string $fonenumber FoneNumber associated with the account (required)
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2014, HTTP status code, HTTP response headers (array of strings)
     */
    public function setFonenumberServiceTypeWithHttpInfo($fonenumber, $service_type, $service_id = null)
    {
        // verify the required parameter 'fonenumber' is set
        if ($fonenumber === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fonenumber when calling setFonenumberServiceType');
        }
        // verify the required parameter 'service_type' is set
        if ($service_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $service_type when calling setFonenumberServiceType');
        }
        // parse inputs
        $resourcePath = "/fonenumbers/{fonenumber}/service";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        // form params
        if ($service_type !== null) {
            $formParams['service_type'] = $this->apiClient->getSerializer()->toFormValue($service_type);
        }
        // form params
        if ($service_id !== null) {
            $formParams['service_id'] = $this->apiClient->getSerializer()->toFormValue($service_id);
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\InlineResponse2014',
                '/fonenumbers/{fonenumber}/service'
            );
     ...
     * @return \Swagger\Client\Model\InlineResponse2014
     */
    public function setFonenumberServiceType_0($fonenumber, $service_type, $service_id = null)
    {
        list($response) = $this->setFonenumberServiceType_0WithHttpInfo($fonenumber, $service_type, $service_id);
        return $response;
    }

    /**
     * Operation setFonenumberServiceType_0WithHttpInfo
     *
     * Set Service Type
     *
     * @param string $fonenumber FoneNumber associated with the account (required)
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2014, HTTP status code, HTTP response headers (array of strings)
     */
    public function setFonenumberServiceType_0WithHttpInfo($fonenumber, $service_type, $service_id = null)
    {
        // verify the required parameter 'fonenumber' is set
        if ($fonenumber === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fonenumber when calling setFonenumberServiceType_0');
        }
        // verify the required parameter 'service_type' is set
        if ($service_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $service_type when calling setFonenumberServiceType_0');
        }
        // parse inputs
        $resourcePath = "/fonenumbers/{fonenumber}/service";
        $httpBody = '';
