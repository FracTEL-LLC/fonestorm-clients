...
public class ApiClient {
    ...
    private String basePath = "https://api.fractel.net/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("APIKeyHeader", new ApiKeyAuth("header", "token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.fractel.net/v2
