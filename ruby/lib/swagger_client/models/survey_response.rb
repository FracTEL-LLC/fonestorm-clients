...
module SwaggerClient
  ...
  class SurveyResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'choice_id')
        self.choice_id = attributes[:'choice_id']
      end
      ...
      if attributes.has_key?(:'survey_id')
    ...
    def hash
      [answer, choice_id, contact, contact_id, created_at, id, question_id, survey_id, updated_at].hash
    end
