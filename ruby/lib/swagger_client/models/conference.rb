...
module SwaggerClient
  ...
  class Conference
    ...
    attr_accessor :before_message

    # Message to play after conference end time.
    attr_accessor :after_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'before_message')
        self.before_message = attributes[:'before_message']
      end

      if attributes.has_key?(:'after_message')
        self.after_message = attributes[:'after_message']
      end

      if attributes.has_key?(:'max_members')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          before_message == o.before_message &&
          after_message == o.after_message &&
    ...
    def hash
      [id, end_time, label, start_time, before_message, after_message, max_members].hash
    end
