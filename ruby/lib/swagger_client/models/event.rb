...
module SwaggerClient
  ...
  class Event
    ...
    attr_accessor :reschedule_count
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reschedule_count')
        self.reschedule_count = attributes[:'reschedule_count']
      end
    ...
    def hash
      [account_id, attendees, created_at, description, end_time, id, location, reschedule_count, status, start_time, title, updated_at].hash
    end
