...
namespace IO.Swagger.Model
{
    ...
    public partial class FoneNumber :  IEquatable<FoneNumber>, IValidatableObject
    {
        ...
        public FoneNumber(string _Fonenumber = default(string), string State = default(string), string RateCenter = default(string), string IsActive = default(string), FoneNumberSmsOptions SmsOptions = default(FoneNumberSmsOptions), FoneNumberVoiceOptions VoiceOptions = default(FoneNumberVoiceOptions), FoneNumberFaxOptions FaxOptions = default(FoneNumberFaxOptions))
        {
