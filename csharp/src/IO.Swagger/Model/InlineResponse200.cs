...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(List<Conference> Conferences = default(List<Conference>))
        {
        ...
        public bool Equals(InlineResponse200 other)
        {
            ...
            return 
                (
                    this.Conferences == other.Conferences ||
                    this.Conferences != null &&
                    this.Conferences.SequenceEqual(other.Conferences)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Conferences != null)
                    hash = hash * 59 + this.Conferences.GetHashCode();
                return hash;
            }
        }
