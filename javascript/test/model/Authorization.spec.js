...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoneStormApi220Breeze.Authorization();
  });
  ...
  describe('Authorization', function() {
    it('should create an instance of Authorization', function() {
      ...
      //var instane = new FoneStormApi220Breeze.Authorization();
      //expect(instance).to.be.a(FoneStormApi220Breeze.Authorization);
    });
