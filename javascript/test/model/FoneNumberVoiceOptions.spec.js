...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoneStormApi220Breeze.FoneNumberVoiceOptions();
  });
  ...
  describe('FoneNumberVoiceOptions', function() {
    it('should create an instance of FoneNumberVoiceOptions', function() {
      // uncomment below and update the code to test FoneNumberVoiceOptions
      //var instane = new FoneStormApi220Breeze.FoneNumberVoiceOptions();
      //expect(instance).to.be.a(FoneStormApi220Breeze.FoneNumberVoiceOptions);
    });
