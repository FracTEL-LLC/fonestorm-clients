...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FoneStormApi240Thunder.InlineResponse2013 = factory(root.FoneStormApi240Thunder.ApiClient, root.FoneStormApi240Thunder.Conference);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('conference')) {
        obj['conference'] = Conference.constructFromObject(data['conference']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Conference} conference
   */
