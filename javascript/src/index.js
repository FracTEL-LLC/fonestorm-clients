...
(function(factory) {
   ...
   * <pre>
   * var FracTelApi212 = require('index'); // See note below*.
   * var xxxSvc = new FracTelApi212.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new FracTelApi212.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new FracTelApi212.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new FracTelApi212.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
