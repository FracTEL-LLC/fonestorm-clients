...
(function(factory) {
   ...
   * <pre>
   * var FracTelApi210 = require('index'); // See note below*.
   * var xxxSvc = new FracTelApi210.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new FracTelApi210.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new FracTelApi210.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new FracTelApi210.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
