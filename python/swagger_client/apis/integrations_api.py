...
class IntegrationsApi(object):
    ...
    def get_integrations_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/integrations', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_integrations_0(self, **kwargs):
        """
        Get Integrations
        Get a list of all integrations.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_0(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_integrations_0_with_http_info(**kwargs)
        else:
            (data) = self.get_integrations_0_with_http_info(**kwargs)
            return data

    def get_integrations_0_with_http_info(self, **kwargs):
        """
        Get Integrations
        Get a list of all integrations.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_0_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integrations_0" % key
                )
            params[key] = val
        del params['kwargs']
