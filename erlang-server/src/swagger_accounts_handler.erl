%% basic handler
-module(swagger_accounts_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ConfigureAccountCdrNotify'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ConfigureAccountCdrNotify_0'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ConfigureAccountCdrNotify' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ConfigureAccountCdrNotify_0' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'GetAccount_0' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'UpdateAccount' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'UpdateAccount_0' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
