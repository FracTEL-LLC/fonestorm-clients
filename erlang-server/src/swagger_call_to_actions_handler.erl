%% basic handler
-module(swagger_call_to_actions_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CreateCallToAction'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'DeleteCallToAction'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'UpdateCallToAction'
    }
) ->
    {[<<"PUT">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CreateCallToAction' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'DeleteCallToAction' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'GetCallToAction' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'GetCallToActions' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'UpdateCallToAction' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
